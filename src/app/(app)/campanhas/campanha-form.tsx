    ...
    <form action={criarCampanha} className="space-y-4">
      ...
      <div>
        ...
        <p className="mt-1 text-[11px] text-stone-600">
          O card mostra a foto numa faixa larga (proporção 3:1) — se vier mais quadrada ou vertical, use
          &ldquo;Enquadramento&rdquo; abaixo pra escolher qual parte fica visível.
          {alvo === "individual" && (
            <>
              {" "}
              Em duelo entre exatamente 2 pessoas essa imagem nem aparece — o card usa a foto de perfil de cada
              uma automaticamente, uma de cada lado.
            </>
          )}
        </p>
      </div>
